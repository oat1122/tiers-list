...
vi.mock(
  "@/app/picture-reveal/_components/picture-reveal-gallery-client",
  () => ({
...
vi.mock(
  ...
  () => ({
    PictureRevealPlayClient: ({
      ...
      <div
        data-picture-reveal-play={game.id}
        data-image-count={game.imageCount}
      >
        {game.title}
      </div>
    ),
...
vi.mock(
  ...
  () => ({
    PictureRevealLocalCreatorClient: () => (
      <div data-picture-reveal-local-creator />
    ),
  }),
);
...
describe("public pages", () => {
  ...
  it("passes an empty public game list to the picture reveal gallery page", async () => {
    ...
    const { default: PictureRevealPage } =
      await import("@/app/picture-reveal/page");
  ...
  it("renders the picture reveal play page with the public playable payload", async () => {
    ...
    const { default: PictureRevealGamePage } =
      await import("@/app/picture-reveal/[id]/page");
  ...
  it("renders the local picture reveal creator route without auth", async () => {
    const { default: PictureRevealCreatePage } =
      await import("@/app/picture-reveal/create/page");
  ...
  it("renders the local picture reveal play route without auth", async () => {
    const { default: PictureRevealCreatePlayPage } =
      await import("@/app/picture-reveal/create/play/page");
