...
export const metadata: Metadata = {
  title: "Tier Lists | Public Gallery",
  description:
    "เลือก public tier lists จากหน้า gallery แล้วเริ่มจัดอันดับต่อใน local editor ได้ทันที",
};
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(280px,0.9fr)] lg:items-end">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-7 text-muted-foreground md:text-lg">
                หน้า gallery นี้รวม public tier lists ที่พร้อมให้หยิบไปใช้ต่อ
                จากนั้นเปิด local editor เพื่อปรับแต่งรายการในแบบของคุณได้เลย
              </p>
            </div>
